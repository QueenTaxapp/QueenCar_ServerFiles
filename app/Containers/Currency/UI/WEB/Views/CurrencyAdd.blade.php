...
@section('content')
    ...
    if(session()->has('_old_input'))    {
        ...
        $currencyName = session()->get('_old_input')["currency_name"];
        $symbol  = session()->get('_old_input')["symbol"];
        $standardName  = session()->get('_old_input')["standard_name"];
                    ...
                    <div class="row">
                        <div class="col s12 m12 l12">
                            <div id="bordered-table">
                                ...
                                <h4 class="header">{{ trans('localization::lang_view.add_currency')}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col s12 m12 l12">
                                        <form action="{{URL::Route('adminCurrencyAddSave')}}" method="post" enctype="multipart/form-data" >
                                            ...
                                            <div class="row">
                                                <div class="col s12 m12 l12">
                                                    ...
                                                    <div class="input-field col s12 m4 l4">
                                                        <input name="currency_name" id="currency" type="text" value="{{ $currencyName}}" class="validate" required >
                                                        <label for="currency" class="active">{{ trans('localization::lang_view.currency_name')}} <sup>*</sup></label>
                                                    </div>
                                                    <div class="input-field col s12 m4 l4">
                                                        <input name="symbol" id="value" type="text" value="{{ $symbol}}" required >
                                                    ...
                                                    <div class="input-field col s12 m4 l4">
                                                        <select name="standard_name" id="standard_name" required >
                                                            ...
                                                            <option value="<?=$key;?>" <?php if($standardName==$key){echo "selected";} ?> ><?=$key;?></option>
                                                            <?php }?>
                                                        </select>
                                            ...
                                            <div class="col s12 m12 l12">
                                                <button class="btn save-btn cyan waves-effect waves-light right" type="submit" name="action">{{ trans('localization::lang_view.save_currency')}}
