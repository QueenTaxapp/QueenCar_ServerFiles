...
<!--<link rel="stylesheet" type="text/css" href="<?php //echo asset('drag/css/multi-select.css'); ?>">-->
    ...
    <style>
        ...
        /*#country-list-driver-name{float:left;list-style:none;margin-top:-3px;padding:0;width:190px;position: absolute;}*/
        /*#country-list-driver-name li{padding: 10px; background: #f0f0f0; border-bottom: #bbb9b9 1px solid;}*/
        /*#country-list -driver-nameli:hover{background:#ece3d2;cursor: pointer;}*/
