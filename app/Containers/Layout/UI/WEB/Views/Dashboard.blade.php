...
@section('content')
            ...
            <div id="card-stats">
                ...
                <div class="row">
                    ...
                    <div class="col s12 m12 l6">
                        ...
                        <div class="col s12  m12 l12">
                            <canvas id="<?=$value['chart'];?>" style=""></canvas>
                        </div>
                    </div>
                    <?php
                    //} // count if
    ...
    <aside id="right-sidebar-nav">
        <ul id="chat-out" class="side-nav rightside-navigation right-aligned ps-container ps-active-y" style="transform: translateX(100%);">
            ...
            <div class="ps-scrollbar-x-rail in-scrolling" style="left: 0px; bottom: 3px;"><div class="ps-scrollbar-x" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 292px; right: 3px;"><div class="ps-scrollbar-y" style="top: 0px; height: 88px;"></div></div>
        </ul>
    </aside>
    ...
    <script type="text/javascript">
        ...
        // $(document).ready(function(){
                ...
                <?php if(array_key_exists('no_of_drivers_registered',$values)){ ?>
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: <?php echo "'".trans('localization::lang_view.drivers')."'";?>,
            ...
            options: {}
                ...
                <?php if(array_key_exists('no_of_users_registered',$values)){ ?>
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                //["January", "February", "March", "April", "May", "June", "July"],
                datasets: [{
                    label: <?php echo "'".trans('localization::lang_view.users')."'";?>,
                    backgroundColor: 'rgb(255, 99, 132)',
                    borderColor: 'rgb(255, 99, 132)',
                    data: [
                        <?php
