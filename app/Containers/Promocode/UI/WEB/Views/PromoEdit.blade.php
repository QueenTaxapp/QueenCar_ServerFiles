                    ...
                    <div class="row">
                        <div class="col s12 m12 l12">
                            <div id="bordered-table">
                                ...
                                <h4 class="header">{{ trans('localization::lang_view.edit_promo_code')}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col s12 m12 l12">
                                        <form action="{{URL::Route('adminPromoUpdate',$promo->id)}}" method="post" enctype="multipart/form-data" >
                                            ...
                                            <div class="row">
                                                <div class="col s12 m12 l12">
                                                    ...
                                                    <div class="input-field col s12 m4 l4">
                                                        <input name="couponCode" id="coupon" type="text" value="<?=$promo->coupon_code?>" class="validate" required >
                                                        <label for="coupon" class="active">{{ trans('localization::lang_view.coupon_code')}} <sup>*</sup></label>
                                                    </div>
                                                    <div class="input-field col s12 m4 l4">
                                                        <input name="value" id="value" type="number" min="1" value="<?=$promo->value?>" required >
                                                    ...
                                                    <div class="input-field col s12 m4 l4">
                                                        <select name="zone" id="zone" required >
                                                            ...
                                                            <option value="<?=$value->id?>" <?php if($promo->zone_id==$value->id){echo "selected";} ?> ><?=$value->name;?></option>
                                                            <?php }?>
                                                        </select>
                                                ...
                                                <div class="col s12 m12 l12">
                                                    <div class="input-field col s12 m6 l6">
                                                        <select name="type" id="type" required >
                                                            ...
                                                            <option value="0" <?php if($promo->type==0){echo "selected";} ?> >{{ trans('localization::lang_view.fixed')}}</option>
                                                            <option value="1" <?php if($promo->type==1){echo "selected";} ?> >{{ trans('localization::lang_view.percentage')}}</option>
                                                        </select>
                                                        <label for="type" class="">{{ trans('localization::lang_view.type')}} <sup>*</sup></label>
                                                    </div>
                                                    <div class="input-field col s12 m6 l6">
                                                        <input name="uses" id="uses" type="number" min="1" value="<?=$promo->uses?>" required>
                                                ...
                                                <div class="col s12 m12 l12">
                                                    <div class="input-field col s12 m6 l6">
                                                        <input name="startDate" id="startDate" type="text" value="<?=$promo->start_date?>" class="datepicker" required>
                                                        <label for="startDate">{{ trans('localization::lang_view.start_date')}} <sup>*</sup></label>
                                                    </div>
                                                    <div class="input-field col s12 m6 l6">
                                                        <input name="expiryDate" id="endDate" type="text" value="<?=$promo->expiry_date?>" class="datepicker" required>
                                            ...
                                            <br>
                                            <div class="col s12 m12 l12">
                                                <button class="btn save-btn cyan waves-effect waves-light right" type="submit" onclick="return ValidateAll()" name="action">{{ trans('localization::lang_view.apply_changes')}}
