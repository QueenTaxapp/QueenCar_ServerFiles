                                ...
                                <div class="row">
                                    ...
                                    <div class="col s12">
                                        <div style="" class="col s6 m3 l3 right">
                                            <a href="{{ URL::Route('zoneTypeAdd',$request->id) }}" class="add-btn waves-effect waves-light btn right tooltipped" data-position="top" data-delay="50" data-tooltip="{{trans('localization::lang_view.add_zone_type')}}" >
                                    ...
                                    <div class="col s12">
                                        ...
                                        <table id="table" class="bordered ">
                                            ...
                                            <tr>
                                                ...
                                                <th>{{ trans('localization::lang_view.type_name')}}</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    foreach($types as $typesValue){
                                                        if($typesValue['id']==$value['type_id']){
                                                            echo $typesValue['name'];
                                                        }
                                                ...
                                                <td>
                                                    <div class="container">
                                                        ...
                                                        <ul id="dropdown<?=$s_no;?>" class="drop dropdown-content " style="white-space: nowrap; opacity: 1;width: 140px; top: 130px; display: none;">
                                                            ...
                                                            <li><a class="grey-text text-darken-2" href="{{ URL::Route('zoneTypeEdit',$value->id) }}">{{ trans('localization::lang_view.edit')}}</a></li>

                                                            <li><a class="<?php if($value->is_active == 0){echo "sweet-active";}else{echo "sweet-inactive";}?> grey-text text-darken-2" href="{{ URL::Route('zoneTypeStatusToggle',$value->id) }}">
