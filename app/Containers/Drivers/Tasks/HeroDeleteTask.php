 ...
 */
class HeroDeleteTask extends Task
{
    /**
     * @param      object
     *
    ...
    public function run($request)
    {
        ...
        $data=HeroModel::where('id',$id)->update(['deleted_at' => date("Y-m-d h:i:s")]);
        $dataHero=HeroDetailsModel::where('hero_id',$id)->update(['deleted_at' => date("Y-m-d h:i:s")]);
        ...
        $message=trans('localization::errors.hero_deleted_successfully');
