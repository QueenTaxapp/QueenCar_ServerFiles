                    ...
                    <div id="bordered-table">
                        ...
                        <div class="col s12 m12 l12">
                            <h4 class="header">{{$title}}
                                <a href="{{ URL::Route('userCompliantView') }}" class="user-state-btn waves-effect waves-light btn tooltipped" data-position="top" data-delay="50" data-tooltip="{{trans('localization::lang_view.user_compliant')}} " style="top: 14px;float: right;">
                                    {{trans('localization::lang_view.user_compliant')}}
                                </a>
                            </h4>
                        </div>
                        ...
                        <div class="col s12 m12 l12">
                            ...
                            <div class="col s12 m12 l12">
                                <div class="row">
                                    <form method="get" action="{{ URL::Route('driverCompliantView') }}">
                                        ...
                                        <div style="float: right" class="col s12 m2 l3">
                                            <a href="{{ URL::Route('compliantView') }}" class="add-btn waves-effect waves-light btn right tooltipped" data-position="top" data-delay="50" data-tooltip="{{trans('localization::lang_view.compliant_view')}}" >
                            ...
                            <div class="col s12 m12 l12">
                                ...
                                <table id="table" class="bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="price">{{ trans('localization::lang_view.driver_name')}}</th>
                                        ...
                                        <td>
                                            ...
                                            <div class="container">
                                                ...
                                                <ul id="dropdown<?=$s_no;?>" class="drop dropdown-content " style="white-space: nowrap; opacity: 1;width: 140px; top: 130px; display: none;">
                                                    <li><a class="grey-text text-darken-2" href="{{ URL::Route('driverCompliantEditPage',$value->id) }}">{{ trans('localization::lang_view.edit')}}</a></li>
                                                    ...
                                                    {
                                                    ?>
                                                    <li><a onclick="" class="sweet-done" href="{{ URL::Route('driverTaken',$value->id) }}">{{ trans('localization::lang_view.taken')}}</a></li>

                                                    <li><a onclick="" class="sweet-done" href="{{ URL::Route('driverSolved',$value->id) }}">{{ trans('localization::lang_view.solved')}}</a></li>
                                                    <?php
                                                    }
                                                    else if ($value->compliant_status == 2)
                                                    { ?>
