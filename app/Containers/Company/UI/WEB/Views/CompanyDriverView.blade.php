                        ...
                        <div class="col s12 m12 l12">
                            <div id="bordered-table">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col s12 m12 l12">
                                        <div class="row">
                                            <form method="get" action="{{ URL::Route('companyDriverView') }}">
                                            ...
                                            <div style="margin-top: -1rem;" class="col col s5 m2 l2">
                                            ...
                                            <div style="float: right" class="col s3 m2 l2 right-align">
                                                <a href="{{ URL::Route('addCompanyDriver') }}" class="add-btn waves-effect waves-light btn tooltipped" data-position="top" data-delay="50" data-tooltip="{{trans('localization::lang_view.add_driver')}}" >
                                                ...
                                                <td>
                                                    <div class="container">
                                                        ...
                                                        <ul id="dropdown<?=$s_no;?>" class="drop dropdown-content " style="white-space: nowrap; opacity: 1;width: 140px; top: 130px; display: none;">
                                                            <li><a class="grey-text text-darken-2" href="{{ URL::Route('editCompanyDriver',$value->id) }}">{{ trans('localization::lang_view.edit')}}</a></li>

                                                            <li><a class="sweet-delete grey-text text-darken-2" href="{{ URL::Route('deleteCompanyDriver',$value->id) }}">{{ trans('localization::lang_view.delete')}}</a></li>

                                                            <?php
                                                                $path = url('company/driver/toogle/status/'.$value->id.'/'.$value->is_approve);
                                                            //  $path = asset('companyStatusToogle/'.$value->id.'/'.$value->is_approve);
                                                            // companyStatusToogle
                                                            ?>
                                                            <li><a class="<?php if($value->is_approve==0){echo "sweet-approve";}else{echo "sweet-decline";} ?> grey-text text-darken-2" href="{{ $path }}">
                                                            ...
                                                            <li><a class="sweet-delete grey-text text-darken-2" href="{{ URL::Route('companyDriverDeleteAccount',$value->id) }}">{{ trans('localization::lang_view.delete_account')}}</a></li>

                                                            <?php  }else{ ?>
                                                            <li><a class="grey-text text-darken-2" href="{{ URL::Route('companyDriverAddAccount',$value->id) }}">{{ trans('localization::lang_view.add_account')}}</a></li>
                                                            <?php  }

                                                            $array = array('id'=>$value->id,'days'=> 3);
                                                            ?>

                                                            <li><a class="grey-text text-darken-2" href="{{ URL("company/driver/income/$value->id/null") }}">{{ trans('localization::lang_view.income')}}</a></li>
