                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m12 l12">
                                <div class="row">
                                    ...
                                    <form method="post" action="{{ URL::Route('companyDriverIncomeValue') }}">
                                        ...
                                        <td>
                                            ...
                                            <div class="container">
                                                ...
                                                <ul id="dropdown<?=$s_no;?>" class="drop dropdown-content " style="white-space: nowrap; opacity: 1;width: 140px; top: 130px; display: none;">
                                                    ...
                                                    <li><a  href="{{ URL::Route('companyDriverIncomePaid',$value->id) }}">{{ trans('localization::lang_view.paid_to_driver')}}</a></li>
