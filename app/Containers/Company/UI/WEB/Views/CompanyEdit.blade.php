                ...
                <div class="col s12 m12 l12">
                    <div id="bordered-table">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m12 l12">
                                <form action="{{URL::Route('companyUpdate',$id)}}" onsubmit="return Validate()" method="post" enctype="multipart/form-data" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s12 m12 l12">
                                            <div class="col s12 m6 l6">
                                                ...
                                                <div class="input-field col s12 m12 l12">
                                                    <input name="document" id="avatar input-file-to-destroy" data-default-file="{{$document_url}}" class="dropify" data-allowed-file-extensions="jpg png jpeg pdf" data-show-errors="true"  data-max-height="2000" type="file">
                                                </div>
                                            </div>
                                            <div class="col s12 m6 l6">
                                                <div class="input-field col s12 m12 l12">
