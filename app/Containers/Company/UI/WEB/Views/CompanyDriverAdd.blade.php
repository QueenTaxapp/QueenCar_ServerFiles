                                ...
                                <div class="row">
                                    ...
                                    <div class="col s12 m12 l12">
                                        <form action="{{URL::Route('adminDriverSave')}}" onsubmit="return Validate()" method="post" enctype="multipart/form-data" >
                                                ...
                                                <div class="col s12 m12 l12">
                                                    ...
                                                    <div class="input-field col s12 m4 l4">
                                                        <select name="country_code" id="country" required >
                                                            ...
                                                            <option value="<?=$value->d_code;?>" <?php if($country_code==$value->d_code){echo "selected";}?> > <?php echo $value->name.' ('.$value->d_code.')';?></option>
                                                            <?php }; ?>
                                                ...
                                                <div class="col s12 m12 l12">
                                                    ...
                                                    <div class="input-field col s12 m6 l6">
                                                        <select name="company" id="company" >
                                                            <option value="{{$id}}" disabled selected>{{$companyName}}</option>
                                                         </select>
                                            ...
                                            <br>
                                            <div class="col s12 m12 l12">
                                                <button class="btn save-btn cyan waves-effect waves-light right" type="submit" onclick="return DocumentValidate()" name="action" value='company'>{{ trans('localization::lang_view.add_driver')}}
