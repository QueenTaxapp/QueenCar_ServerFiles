                        ...
                        <div class="col s12 m12 l12">
                            <div id="bordered-table">
                                ...
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <h4 class="header">{{$title}}
                                                <a href="{{ URL::Route('userReview') }}" class="user-state-btn waves-effect waves-light btn right tooltipped" data-position="top" data-delay="50" data-tooltip="{{trans('localization::lang_view.to_view_user_review')}}" >
                                                    {{ trans('localization::lang_view.user_review')}}
                                                </a>
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col s12 m12 l12">
                                        <div class="row">
                                            <form method="get" action="{{ URL::Route('driverReview') }}">
                                                ...
                                                <td>
                                                    <div class="container">
                                                        ...
                                                        <ul id="dropdown<?=$s_no;?>" class="drop dropdown-content " style="white-space: nowrap; opacity: 1;width: 140px; top: 130px; display: none;">
                                                            <li><a class="grey-text text-darken-2" href="{{ URL::Route('editdriverReview',$value->id) }}">{{ trans('localization::lang_view.edit')}}</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
