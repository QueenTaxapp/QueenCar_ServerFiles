                    ...
                    <div class="row">
                        <div class="col s12 m12 l12">
                            <div id="bordered-table">
                                ...
                                <h4 class="header">
                                    <?=$title;?>
                                    <span class="back-button" style="float: right;"><a class="tooltipped" href="{{URL::Route('driverReview')}}" data-position="left" data-delay="50" data-tooltip="{{ trans('localization::lang_view.to_view_driver_review')}}" >{{ trans('localization::lang_view.back')}}<i class="material-icons">reply</i></a></span>
                                </h4>

                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        
                                        <form method=post action="{{ URL::Route('saveEditDriverReview') }}">


                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            <input type="hidden" name="id" value="{{ $request->id }}">
                                            <input type="hidden" name="driver_id" value="{{ $result->driver_id }}">
