...
@section('content')
    ...
    <section id="content">
        ...
        <div class="container">
            ...
            <br>
            <h4>{{ trans('localization::lang_view.spent_history')}}
                <div style="float: right" class="col s2 m2 l2 right-align">
                    <a href="{{ URL::Route('adminUserWallet',$request->id) }}" class="wallet-spent-btn waves-effect waves-light btn tooltipped" data-position="top" data-delay="50" data-tooltip="{{trans('localization::lang_view.spent_history')}}" >
                        {{ trans('localization::lang_view.wallet_history')}}
                    </a>
                </div></h4>
            <br><hr>
            <div class="row">
                <div class="col s12 m12 l12">
                    ...
                    <div class="pagination" align="left" id="paglink">
                        ...
                        echo $wallet_spent->appends(array())->links();
                        ?>
                    </div><br><br><br><br><br>
