...
if($request->session()->get('filter_type') != ''&& $request->session()->get('filter_value')!= '')
{
    ...
    $test=str_replace('user',trans('localization::lang_view.user'),$test);
                        ...
                        <div class="col s12 m12 l12">
                            <div id="bordered-table">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col s12 m12 l12">
                                        <div class="row">
                                            <form method="get" action="{{ URL::Route('adminUserView') }}">
                                            ...
                                            <div style="margin-top: -1rem;" class="col s5 m2 l2">
                                                <select class="select" name="filter_type">
                                                    <option value="name" <?php
                                                            ...
                                                            } ?> >{{ trans('localization::lang_view.user').' '. trans('localization::lang_view.name')}}</option>
                                                    <option value="email" <?php
                                                            if (isset($_GET['filter_type']) && $_GET['filter_type'] == 'email') {
                                                                echo 'selected="selected"';
                                                            } ?> >{{ trans('localization::lang_view.user').' '. trans('localization::lang_view.email')}}</option>
                                                    <option value="phone" <?php
                                                            if (isset($_GET['filter_type']) && $_GET['filter_type'] == 'phone') {
                                                                echo 'selected="selected"';
                                                            } ?> >{{ trans('localization::lang_view.user').' '. trans('localization::lang_view.phone_number')}}</option>
                                                </select>
                                            </div>
                                            <div class="col s4 m2 l2">
                                            ...
                                            <div style="float: right" class="col s3 m2 l2 right-align">
                                                <a href="{{ URL::Route('adminUserAdd') }}" class="add-btn waves-effect waves-light btn tooltipped" data-position="top" data-delay="50" data-tooltip="{{trans('localization::lang_view.add_user')}}" >
                                    ...
                                    <div class="col s12 m12 l12">
                                        ...
                                        <table id="table" class="bordered ">
                                            ...
                                            <tr>
                                                ...
                                                <th data-field="price">{{ trans('localization::lang_view.referral_code')}}</th>
                                                ...
                                                <td>
                                                    <div class="container">
                                                        ...
                                                        <ul id="dropdown<?=$s_no;?>" class="drop dropdown-content " style="white-space: nowrap; opacity: 1;width: 140px; top: 130px; display: none;">
                                                            <li><a class="grey-text text-darken-2" href="{{ URL::Route('adminUserEdit',$value->id) }}">{{ trans('localization::lang_view.edit')}}</a></li>

                                                            <li><a class="sweet-delete grey-text text-darken-2" href="{{ URL::Route('adminUserDelete',$value->id) }}">{{ trans('localization::lang_view.delete')}}</a></li>

                                                            <li><a class="<?php if($value->is_active==0){echo "sweet-active";}else{echo "sweet-inactive";} ?> grey-text text-darken-2" href="{{ URL::Route('adminUserActive',$value->id) }}">
                                                            ...
                                                            <li><a class="grey-text text-darken-2" href="{{ URL::Route('adminUserWallet',$value->id) }}">{{ trans('localization::lang_view.wallet')}}</a></li>
