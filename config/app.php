...
return [
    ...
    'app_name'=>'tapngo',
    'email_color'=>'red',
    'company_email_address'=>'company@gmail.com',
    /*
    |--------------------------------------------------------------------------
    | Application Name
    |--------------------------------------------------------------------------
...
//    'locale' => 'en',
    'locales' => ['en' => 'English', 'spa' => 'spanish'],

    'languages' => array('en','fr','ar','spa'),
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    // 'accountid' => "ACcefd35c49910c81951a203c68d3b82c4",
    // 'authToken' => "edbbd58aa24dc9e6a55a2adca29ca062",
    // 'twilioNumber' => "+1 385-282-6487",

     'twillo_account_sid' => 'ACcefd35c49910c81951a203c68d3b82c4',
     'twillo_auth_token' => 'edbbd58aa24dc9e6a55a2adca29ca062',
     'twillo_number' => '+1 385-282-6487',
    ...
    */
    ...
    'aliases' => [
        ...
        //'dispatch'=>Illuminate\Contracts\Bus\Dispatcher\Dispatcher::class,
